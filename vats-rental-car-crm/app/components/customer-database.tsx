      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="max-w-3xl max-h-[95vh] overflow-hidden flex flex-col">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={async (e) => {
                    ...
                    if (file) {
                      console.log("Aadhar file selected:", file.name)
                      try {
                ...
                />
                {newCustomer.aadharUrl && (
                  <p className="text-sm text-green-600 mt-1">✓ Aadhar card uploaded</p>
                )}
              </div>
              <div>
                <Label htmlFor="dlUpload">Upload Driving License</Label>
                <Input
                  id="dlUpload"
                  type="file"
                  accept="image/*,application/pdf"
                  onChange={async (e) => {
                    const file = e.target.files?.[0]
                    if (file) {
                      console.log("DL file selected:", file.name)
                      try {
                        // Convert file to base64 for storage
                        const reader = new FileReader()
                        reader.onload = (event) => {
                ...
                />
                {newCustomer.dlUrl && (
                  <p className="text-sm text-green-600 mt-1">✓ Driving license uploaded</p>
                )}
              </div>
              <div>
            ...
            <div className="flex justify-end space-x-2 mt-4 pt-4 border-t bg-white">
