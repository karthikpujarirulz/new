...
export default function FleetMaintenance() {
  ...
  const filteredRecords = selectedCar && selectedCar !== "all"
        ...
        <CardContent>
          <div className="flex items-center space-x-4">
            ...
            {selectedCar && selectedCar !== "all" && (
              <Button variant="outline" onClick={() => setSelectedCar("all")}>
                Clear Filter
              </Button>
            )}
          </div>
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">
              {selectedCar && selectedCar !== "all" ? "No records for the selected vehicle" : "Start by adding your first maintenance record"}
            </p>
